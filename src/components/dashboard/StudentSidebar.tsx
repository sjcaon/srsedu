import { LayoutDashboard, ClipboardList, CalendarCheck, Clock, FileText, Mail, LogOut, GraduationCap } from 'lucide-react';
        ...
        <div className="p-4 flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="overflow-hidden">
              ...
              <p className="text-xs text-sidebar-foreground/60 truncate">Student Panel</p>
            </div>
          )}
        </div>
        <SidebarGroup>
          <SidebarGroupLabel>My Academics</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {menuItems.map((item) => (
